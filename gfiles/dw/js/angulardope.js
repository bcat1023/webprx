...
var dealerUpgrades = [
    ...
    new DealerUpgrade('iPhone 14 Pro', 'A state of the art smartphone. Allows the dealer to sell a small amount of other drugs on the side', 900, 1, 1, 0.1, '+10% secondary sales'),
